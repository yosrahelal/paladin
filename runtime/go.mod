module github.com/kaleido-io/paladin-runtime
...
replace github.com/kaleido-io/paladin-transaction-manager => ../transaction-manager // go.work doesn't work: https://github.com/golang/go/issues/50750
