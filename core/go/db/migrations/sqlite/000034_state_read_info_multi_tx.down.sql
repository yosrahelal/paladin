...
INSERT OR IGNORE INTO state_read_records_new SELECT * FROM state_read_records;
...
INSERT OR IGNORE INTO state_info_records_new SELECT * FROM state_info_records;
