...
func TestPrivateTxManagerRemoteNotaryEndorser(t *testing.T) {
	...
	remoteEngineMocks.keyManager.On("ResolveKeyNewDatabaseTX", mock.Anything, "domain1.contract1.notary@"+remoteNodeID, algorithms.ECDSA_SECP256K1, verifiers.ETH_ADDRESS).
		Return(keyMapping, nil)
