...
var (
	...
	MsgComponentPublicTransactionStoreInitError    = ffe("PD010023", "Error initializing public transaction store")
	MsgComponentPublicTransactionManagerStartError = ffe("PD010024", "Error starting public transaction manager ")
