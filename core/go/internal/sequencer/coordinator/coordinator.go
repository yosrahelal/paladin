...
func NewCoordinator(
	...
	c.electGracePeriod = confutil.IntMin(configuration.ElectGracePeriod, pldconf.SequencerMinimum.ElectGracePeriod, *pldconf.SequencerDefaults.ElectGracePeriod)
