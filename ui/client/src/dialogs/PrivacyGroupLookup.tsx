...
export const PrivacyGroupLookupDialog: React.FC<Props> = ({
  ...
  //   queryKey: [`domain-contract-${idOrContractAddress}`],
  //   queryFn: () => getDomainContractByAddress(idOrContractAddress),
  //   enabled: isValidAddress(idOrContractAddress),
  //   refetchOnMount: false,
  //   retry: false
  // });

  const { refetch: privacyGroupById } = useQuery({
    queryKey: [`privacy-group-by-${idOrContractAddress}`],
