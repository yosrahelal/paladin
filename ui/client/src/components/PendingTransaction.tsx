    ...
    <Box sx={{
      ...
      <Grid2 container direction="column" spacing={2}>
        ...
        <Grid2 textAlign="center">
            <Timestamp date={new Date(pendingTransaction.created)} />
            <Typography align="center" variant="body2" color="textSecondary">{t('created')}</Typography>
          </Grid2>
          <Grid2 textAlign="center">
            <Hash title={t('id')} hash={pendingTransaction.id} />
            <Typography align="center" variant="body2" color="textSecondary">{t('id')}</Typography>
          </Grid2>
          <Grid2>
            <Typography align="center" variant="h6" color="textPrimary">{pendingTransaction.domain}</Typography>
            <Typography align="center" variant="body2" color="textSecondary">{t('domain')}</Typography>
          </Grid2>
          <Grid2>
            <Typography align="center" variant="h6" color="textPrimary">{t(pendingTransaction.from)}</Typography>
            <Typography align="center" variant="body2" color="textSecondary">{t('from')}</Typography>
          </Grid2>
          <Grid2>
            <Typography align="center" variant="h6" color="textPrimary">{t(pendingTransaction.type)}</Typography>
