...
var INIT_DEPLOY = (&proto.InitDeployRequest{}).ProtoReflect().Descriptor().FullName()
var PREPARE_DEPLOY = (&proto.PrepareDeployRequest{}).ProtoReflect().Descriptor().FullName()
