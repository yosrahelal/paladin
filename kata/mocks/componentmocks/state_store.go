...
// RunInDomainContextFlush provides a mock function with given fields: domainID, fn
func (_m *StateStore) RunInDomainContextFlush(domainID string, fn statestore.DomainContextFunction) error {
	ret := _m.Called(domainID, fn)

	if len(ret) == 0 {
		panic("no return value specified for RunInDomainContextFlush")
	}
