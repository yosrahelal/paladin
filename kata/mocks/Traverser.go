...
func (_m *Traverser[T]) IsEqual(e *filters.OpSingleVal, fieldName string, field filters.FieldResolver, testValue driver.Value) filters.Traverser[T] {
	...
	var r0 filters.Traverser[T]
	if rf, ok := ret.Get(0).(func(*filters.OpSingleVal, string, filters.FieldResolver, driver.Value) filters.Traverser[T]); ok {
...
func (_m *Traverser[T]) IsGreaterThan(e *filters.OpSingleVal, fieldName string, field filters.FieldResolver, testValue driver.Value) filters.Traverser[T] {
	ret := _m.Called(e, fieldName, field, testValue)
...
func (_m *Traverser[T]) IsGreaterThanOrEqual(e *filters.OpSingleVal, fieldName string, field filters.FieldResolver, testValue driver.Value) filters.Traverser[T] {
	ret := _m.Called(e, fieldName, field, testValue)
...
func (_m *Traverser[T]) IsIn(e *filters.OpMultiVal, fieldName string, field filters.FieldResolver, testValues []driver.Value) filters.Traverser[T] {
	...
	var r0 filters.Traverser[T]
	if rf, ok := ret.Get(0).(func(*filters.OpMultiVal, string, filters.FieldResolver, []driver.Value) filters.Traverser[T]); ok {
...
func (_m *Traverser[T]) IsLessThan(e *filters.OpSingleVal, fieldName string, field filters.FieldResolver, testValue driver.Value) filters.Traverser[T] {
	ret := _m.Called(e, fieldName, field, testValue)
...
func (_m *Traverser[T]) IsLessThanOrEqual(e *filters.OpSingleVal, fieldName string, field filters.FieldResolver, testValue driver.Value) filters.Traverser[T] {
	ret := _m.Called(e, fieldName, field, testValue)
...
func (_m *Traverser[T]) IsLike(e *filters.OpSingleVal, fieldName string, field filters.FieldResolver, testValue driver.Value) filters.Traverser[T] {
	ret := _m.Called(e, fieldName, field, testValue)
...
func (_m *Traverser[T]) IsNull(e *filters.Op, fieldName string, field filters.FieldResolver) filters.Traverser[T] {
	...
	var r0 filters.Traverser[T]
	if rf, ok := ret.Get(0).(func(*filters.Op, string, filters.FieldResolver) filters.Traverser[T]); ok {
