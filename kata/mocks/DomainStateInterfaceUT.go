...
// DomainStateInterfaceUT is an autogenerated mock type for the DomainStateInterfaceUT type
type DomainStateInterfaceUT struct {
	mock.Mock
}

// CreateNewStates provides a mock function with given fields: sequenceID, states
func (_m *DomainStateInterfaceUT) CreateNewStates(sequenceID uuid.UUID, states []*statestore.NewState) ([]*statestore.State, error) {
...
func (_m *DomainStateInterfaceUT) EnsureABISchemas(defs []*abi.Parameter) ([]statestore.Schema, error) {
	ret := _m.Called(defs)
...
func (_m *DomainStateInterfaceUT) FindAvailableStates(schemaID string, query *filters.QueryJSON) ([]*statestore.State, error) {
...
func (_m *DomainStateInterfaceUT) Flush(successCallback ...statestore.DomainContextFunction) error {
...
func (_m *DomainStateInterfaceUT) MarkStatesRead(sequenceID uuid.UUID, stateIDs []string) error {
...
func (_m *DomainStateInterfaceUT) MarkStatesSpending(sequenceID uuid.UUID, stateIDs []string) error {
	ret := _m.Called(sequenceID, stateIDs)
...
func (_m *DomainStateInterfaceUT) ResetSequence(sequenceID uuid.UUID) error {
...
func (_m *DomainStateInterfaceUT) UnitTestFlushSync() error {
	ret := _m.Called()
...
// NewDomainStateInterfaceUT creates a new instance of DomainStateInterfaceUT. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewDomainStateInterfaceUT(t interface {
	mock.TestingT
	Cleanup(func())
}) *DomainStateInterfaceUT {
	mock := &DomainStateInterfaceUT{}
	mock.Mock.Test(t)
