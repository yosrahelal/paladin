...
var (
	...
	MsgUnsupportedKeyStoreType           = ffe("PD011407", "Unsupported key store type: '%s'")
	MsgHierarchicalRequiresLoading       = ffe("PD011408", "Hierarchical Deterministic (HD) wallet function implemented in the signing module requires in-memory key material (disableKeyLoading=true)")
	MsgStoreRequiresKeyLoadingForAlgo    = ffe("PD011409", "Key store '%s' requires in-memory key material for the combination of algorithms %s (disableKeyLoading=true)")
