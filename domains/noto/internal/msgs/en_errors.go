...
var (
	...
	MsgNoParamAccount                     = pde("PD200032", "Parameter 'account' is required")
	MsgErrorNonFungibleTokenNotSupported  = pde("PD200033", "Non-fungible tokens are not supported in this query: %s")
	MsgErrorValidateInitCallTxSpec        = pde("PD200034", "Failed to validate init call transaction spec. %s")
	MsgErrorValidateExecCallTxSpec        = pde("PD200035", "Failed to validate execute call transaction spec. %s")
	MsgErrorGetAccountBalance             = pde("PD200036", "Failed to get account balance. %s")
	MsgErrorHandlerImplementationNotFound = pde("PD200037", "Handler implementation not found. %s")
)
