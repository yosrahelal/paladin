...
func (n *Noto) prepareInputs(ctx context.Context, stateQueryContext string, owner ethtypes.Address0xHex, amount *ethtypes.HexInteger) ([]*types.NotoCoin, []*prototk.StateRef, *big.Int, error) {
