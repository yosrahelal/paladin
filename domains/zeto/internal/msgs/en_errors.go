...
var (
	...
	MsgErrorGenerateRandomNumber           = ffe("PD210108", "Failed to generate random number")
	MsgErrorHashState                      = ffe("PD210109", "Failed to create Poseidon hash for token. %s")
	MsgErrorTokenIDToString                = ffe("PD210111", "Failed to convert token ID to string. %s")
	MsgInvalidUTXO                         = ffe("PD210112", "Failed to set UTXO. %s")
