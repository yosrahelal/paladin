...
var (
	...
	MsgErrorUnmarshalLockParams           = ffe("PD210059", "Failed to unmarshal lock parameters. %s")
	...
	MsgErrorLockDelegateNotFound          = ffe("PD210109", "lock delegate not found by ID in the local wallet: %s")
	MsgErrorMissingLockInputs             = ffe("PD210110", "locked inputs are required")
	MsgErrorQueryLockedInputs             = ffe("PD210111", "Failed to query the state store for locked inputs. Expected: %d. Found: %d")
	MsgErrorInputNotLocked                = ffe("PD210112", "Input %s is not locked")
	MsgErrorInsufficientInputAmount       = ffe("PD210113", "Insufficient input amount (total=%s) for the transfers (total=%s)")
	MsgErrorNoLockedInputs                = ffe("PD210114", "No locked inputs found")
	MsgErrorParseInfoStates               = ffe("PD210115", "Failed to parse info states. %s")
	MsgErrorDecodeDelegateExtras          = ffe("PD210116", "Failed to decode delegate in extras. %s")
)
