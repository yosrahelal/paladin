...
func deployDomainContracts(ctx context.Context, rpc rpcclient.Backend, deployer string, config *domainConfig) (*ZetoDomainContracts, error) {
...
func deployImplementations(ctx context.Context, rpc rpcclient.Backend, deployer string, contracts []domainContract) (map[string]*tktypes.EthAddress, map[string]abi.ABI, error) {
...
func deployContract(ctx context.Context, rpc rpcclient.Backend, deployer string, contract *domainContract, deployedContracts map[string]*tktypes.EthAddress) (*tktypes.EthAddress, abi.ABI, error) {
...
func deployBytecode(ctx context.Context, rpc rpcclient.Backend, deployer string, build *solutils.SolidityBuild) (*tktypes.EthAddress, error) {
	var addr string
