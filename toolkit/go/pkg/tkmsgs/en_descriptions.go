...
var (
	...
	PrivacyGroupInputDomain             = pdm("PrivacyGroupInput.domain", "The domain that will manages the privacy group")
	PrivacyGroupInputMembers            = pdm("PrivacyGroupInput.members", "The fully qualified identities of each member of the privacy group")
	PrivacyGroupInputProperties         = pdm("PrivacyGroupInput.properties", "Properties to supply to the domain that will be included in the final genesis state of the group. Domains specify well known properties can override behavior. Indexed properties are queryable and should be used for lookup")
	PrivacyGroupInputPropertiesABI      = pdm("PrivacyGroupInput.propertiesABI", "Optional ABI for the supplied properties. If omitted then an ABI will be auto-generated based on the types of input, with the top-level properties automatically indexed")
	...
	PrivacyGroupGenesisSignature   = pdm("PrivacyGroup.genesisSignature", "String summary of the genesis schema")
	PrivacyGroupGenesisABI         = pdm("PrivacyGroup.genesisABI", "The full ABI of the genesis schema - only returned when querying directly by ID")
