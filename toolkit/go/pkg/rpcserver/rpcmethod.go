...
func RPCMethod0[R any](impl func(ctx context.Context) (R, toolkitrpcclient.RPCCode, error)) RPCHandler {
	return HandlerFunc(func(ctx context.Context, req *rpcclient.RPCRequest) *rpcclient.RPCResponse {
		var result R
		code, err := parseParams(ctx, req)
		if err == nil {
			result, code, err = impl(ctx)
		}
		return mapResponse(ctx, req, result, code, err)
	})
}

func RPCMethod1[R any, P0 any](impl func(ctx context.Context, param0 P0) (R, toolkitrpcclient.RPCCode, error)) RPCHandler {
	return HandlerFunc(func(ctx context.Context, req *rpcclient.RPCRequest) *rpcclient.RPCResponse {
		var result R
		param0 := new(P0)
...
func RPCMethod2[R any, P0 any, P1 any](impl func(ctx context.Context, param0 P0, param1 P1) (R, toolkitrpcclient.RPCCode, error)) RPCHandler {
	return HandlerFunc(func(ctx context.Context, req *rpcclient.RPCRequest) *rpcclient.RPCResponse {
		var result R
		param0 := new(P0)
		param1 := new(P1)
		...
		if err == nil {
			result, code, err = impl(ctx, *param0, *param1)
		}
		return mapResponse(ctx, req, result, code, err)
	})
}

func RPCMethod3[R any, P0 any, P1 any, P2 any](impl func(ctx context.Context, param0 P0, param1 P1, param2 P2) (R, toolkitrpcclient.RPCCode, error)) RPCHandler {
	return HandlerFunc(func(ctx context.Context, req *rpcclient.RPCRequest) *rpcclient.RPCResponse {
		var result R
		param0 := new(P0)
		param1 := new(P1)
		...
		if err == nil {
			result, code, err = impl(ctx, *param0, *param1, *param2)
		}
		return mapResponse(ctx, req, result, code, err)
	})
}

func RPCMethod4[R any, P0 any, P1 any, P2 any, P3 any](impl func(ctx context.Context, param0 P0, param1 P1, param2 P2, param3 P3) (R, toolkitrpcclient.RPCCode, error)) RPCHandler {
	return HandlerFunc(func(ctx context.Context, req *rpcclient.RPCRequest) *rpcclient.RPCResponse {
		var result R
		param0 := new(P0)
		param1 := new(P1)
		...
		if err == nil {
			result, code, err = impl(ctx, *param0, *param1, *param2, *param3)
		}
		return mapResponse(ctx, req, result, code, err)
	})
}

func RPCMethod5[R any, P0 any, P1 any, P2 any, P3 any, P4 any](impl func(ctx context.Context, param0 P0, param1 P1, param2 P2, param3 P3, param4 P4) (R, toolkitrpcclient.RPCCode, error)) RPCHandler {
	return HandlerFunc(func(ctx context.Context, req *rpcclient.RPCRequest) *rpcclient.RPCResponse {
		var result R
		param0 := new(P0)
		param1 := new(P1)
		...
		if err == nil {
			result, code, err = impl(ctx, *param0, *param1, *param2, *param3, *param4)
		}
		return mapResponse(ctx, req, result, code, err)
	})
}

func parseParams(ctx context.Context, req *rpcclient.RPCRequest, params ...interface{}) (toolkitrpcclient.RPCCode, error) {
	if len(req.Params) != len(params) {
		return toolkitrpcclient.RPCCodeInvalidRequest, i18n.NewError(ctx, pldmsgs.MsgJSONRPCIncorrectParamCount, req.Method, len(params), len(req.Params))
	}
	for i := range params {
		b := req.Params[i].Bytes()
		if err := json.Unmarshal(b, &params[i]); err != nil {
			return toolkitrpcclient.RPCCodeInvalidRequest, i18n.NewError(ctx, pldmsgs.MsgJSONRPCInvalidParam, req.Method, i, err)
		}
	}
	return 0, nil
}

func mapResponse(ctx context.Context, req *rpcclient.RPCRequest, result interface{}, code toolkitrpcclient.RPCCode, err error) *rpcclient.RPCResponse {
	if err == nil {
	...
	if code == 0 {
		code = toolkitrpcclient.RPCCodeInternalError
	}
