...
Paladin is a privacy preserving transaction manager for Ethereum. It gives enterprises control of sensitive information without compromising transparency or scalability.
...
- Paladin supports Privacy Preserving Smart Contracts, and provides samples out-of-the-box
    ...
    - _All_ store state in the EVM base ledger in a securely masked format preserving
        ...
        - Learn more about [Privacy](./pente.md)
- Paladin provides a high performance transaction manager that distributes the orchestration of transaction assembly, submission and confirmation across Paladin runtimes
    ...
    - Learn more about [Distributed transaction management](./distributed_sequencer_overview.md) 
