...
Configure the jsonrpc and ws endpoints for the blockchain node you wish this Paladin node to connect to.
...
https://github.com/LF-Decentralized-Trust-labs/paladin/blob/main/config/pkg/pldconf/config.go defines the full set of Paladin configuration.
